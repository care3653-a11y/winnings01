...
# CONFIG
# =========================
PAYSTACK_SECRET_KEY = os.getenv("PAYSTACK_SECRET_KEY")if not PAYSTACK_SECRET_KEY:
...
def create_payment(email: str, telegram_id: int):
    ...
    if not PAYSTACK_SECRET_KEY:
        return None, "Payment service not configured"url = "https://api.paystack.co/transaction/initialize"
...
def verify_payment(reference: str):
    ...
    """
    if not PAYSTACK_SECRET_KEY:
        return False, "Payment service not configured"url = f"https://api.paystack.co/transaction/verify/{reference}"
